...
public class PopularRagisAdapter extends RecyclerView.Adapter<PopularRagisAdapter.ShabadViewHolder>  {
    ...
    private List<PopRagiAndShabad.RaagisInfo> shabadList;
    int pos = 0;
    ...
    public PopularRagisAdapter(Context context, List<PopRagiAndShabad.RaagisInfo> shabadList) {
    ...
    @Override
    public PopularRagisAdapter.ShabadViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_raagi, parent, false);

        return new PopularRagisAdapter.ShabadViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final PopularRagisAdapter.ShabadViewHolder holder, final int position) {
        pos = position;
        final PopRagiAndShabad.RaagisInfo shabad = shabadList.get(position);
