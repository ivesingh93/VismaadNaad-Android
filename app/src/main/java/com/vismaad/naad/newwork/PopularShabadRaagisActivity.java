...
//        }
   ...
   /*     registerReceiver(mBroadcastReceiver, new IntentFilter("start.fragment.action"));
        ...
        LocalBroadcastManager.getInstance(PopularShabadRaagisActivity.this).
        ...
        btnRate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!JBSehajBaniPreferences.getYesRating(mSharedPreferences).equalsIgnoreCase("YES")) {
                    ...
                    Toast.makeText(PopularShabadRaagisActivity.this, "You already given the rating", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        btnFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!JBSehajBaniPreferences.getYesFeedback(mSharedPreferences).equalsIgnoreCase("YES")) {
                    ...
                    Toast.makeText(PopularShabadRaagisActivity.this, "You already given the feedback", Toast.LENGTH_LONG).show();
                }
                dialog.dismiss();
            }
        });
                ...
                call.enqueue(new Callback<JsonElement>() {
                    ...
                    public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                        ...
                        try {
                            ...
                            Toast toast = Toast.makeText(PopularShabadRaagisActivity.this, msg, Toast.LENGTH_LONG);
    ...
    public void createDialog() {
        // dialog.show();
        final Dialog dialog = new Dialog(PopularShabadRaagisActivity.this);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Close dialog
                dialog.dismiss();
                //Intent mIntent = new Intent(PopularShabadRaagisActivity.this, PopularShabadRaagisActivity.class);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mIntent = new Intent(PopularShabadRaagisActivity.this, WelcomeActivity.class);
                startActivity(mIntent);
                finish();
                dialog.dismiss();
            }
